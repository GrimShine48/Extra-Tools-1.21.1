...
public class ScytheUsageEvent implements PlayerBlockBreakEvents.Before{
    ...
    public boolean beforeBlockBreak(World world, PlayerEntity player, BlockPos pos,
        ...
        if(mainHandItem.getItem() instanceof ScytheItem hammer && player instanceof ServerPlayerEntity serverPlayer) {
            if(HARVESTED_BLOCKS.contains(pos)) {
                return true;
            }

            for(BlockPos position : ScytheItem.getBlocksToBeDestroyed(1, pos, serverPlayer)) {
